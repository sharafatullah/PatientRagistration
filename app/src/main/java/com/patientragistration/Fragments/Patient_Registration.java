...
public class Patient_Registration extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_patient__registration, container, false);

        mRevealLayout=(RevealLayout)view.findViewById(R.id.patient_registration);
